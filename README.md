...
また、意図しない過剰入力でも破綻しにくいよう、SDKで使用する範囲に合わせてコントローラーの可動域を制限しています。
使用しない値はロック・非表示にし、初めて触っても扱いが分かりやすいようにしています。

![Beam SDK](docs/gifs/sdk_limit.gif)
